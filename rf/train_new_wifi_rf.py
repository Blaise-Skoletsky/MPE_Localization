"""
使用 new_wifi_cleaned.csv 訓練 Random Forest 模型 (80/20 分割)
"""
...
print("="*70)
print("使用 new_wifi_cleaned.csv 訓練 Random Forest (80/20 分割)")
print("="*70)

# 1. 載入資料
print("\n【步驟 1】載入資料...")
data = pd.read_csv('new_wifi_cleaned.csv')
...
# 7. 儲存模型
print("\n【步驟 6】儲存模型...")
model_file = 'new_wifi_rf_model.joblib'
features_file = 'new_wifi_rf_features.json'
...
results_file = 'new_wifi_rf_predictions.csv'
...
plt.tight_layout()
plt.savefig('new_wifi_rf_results.png', dpi=300, bbox_inches='tight')
print("已儲存: new_wifi_rf_results.png")
